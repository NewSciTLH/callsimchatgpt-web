...
<div class="section-footer {classes}" class:pin-footer={pin}>
  ...
  <div class="content has-text-centered credit-footer">
    <p>
      ...
      <a target="_blank" href="https://www.callsimulator.com/">Call Simulator</a>
      </span>
      <a target="_blank" class="ml-4" href="https://github.com/NewSciTLH/callsimchatgpt-web"><span style="position:absolute" class="icon default-text"><Fa size="2x" icon="{faGithub}"/></span></a>
